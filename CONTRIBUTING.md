...
[`notes/matching-style.md`](notes/matching-style.md) covers the pret DS decomps for the
same compiler family, including which of their levers do **not** transfer to our pin.
