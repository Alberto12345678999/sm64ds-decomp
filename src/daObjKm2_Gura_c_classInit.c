...
/* Reconstructed source-style name: SM64DS proves daObjKm2_Gura_c through
 * RTTI, allocation size, vtable identity, and the KM2_GURA registry profile;
 * later EAD lineage supplies classInit. Exact original spelling is not
 * preserved. Historical alias: TiltingPlatformBfs_Spawn. */
int *daObjKm2_Gura_c_classInit(void)
{
