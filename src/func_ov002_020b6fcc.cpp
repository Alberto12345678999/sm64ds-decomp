...
extern "C" void _ZNK11SurfaceInfo12CopyNormalToER7Vector3(void* si, void* out);
extern "C" s16 _ZN5Actor12ReflectAngleE5Fix12IiES1_s(void* self, int a, int b, short c);
extern "C" void* _ZN5Actor10FindWithIDEj(unsigned id);
extern "C" int _ZN6Player15IsCollectingCapEv(void* p);
extern "C" void _ZN6Player15InitVanishLuigiEv(void* p);
extern "C" void _ZN9ActorBase18MarkForDestructionEv(void* self);
extern "C" void _ZN6Player14InitMetalWarioEv(void* p);
extern "C" int _ZN8SaveData16HasPlayerLostCapEv(void);
extern void func_ov002_020b7f2c(void* c, void* pmf);
extern "C" int _ZN6Player17SetNoControlStateEhih(void* p, u8 a, int b, u8 c);
extern "C" void _ZN6Player18SetNewHatCharacterEjjb(void* p, unsigned a, unsigned b, bool c);
