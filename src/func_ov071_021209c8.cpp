...
extern "C" {
struct BTP_File;
extern "C" void _ZN15TextureSequence7SetFileER8BTP_Filei5Fix12IiEj(char* a, struct BTP_File* f, int b, int c, unsigned int d);
extern "C" void _ZN9Animation8SetFlagsEi(char* a, int f);
