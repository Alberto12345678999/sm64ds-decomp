 ...
 * The project's daObjWc_Obj05_c implementation aliases remain unchanged.
 * Historical alias: daObjWc_Obj05_c_Spawn. */
int *daObjWc_Obj05_c_classInit(void)
{
    int *p = (int *)_ZN7fBase_cnwEj(816);
    if (p) { _ZN10dBgActor_cC2Ev(p); p[0] = (int)_ZTV15daObjWc_Obj05_c; }
    return p;
}
