...
extern "C" void _ZN6Player4HurtERK7Vector3j5Fix12IiEjjj(void *p, const struct Vector3 *v, unsigned int a, int fix, unsigned int b, unsigned int d, unsigned int e);
