...
extern "C" int _ZN9Animation7AdvanceEv(char* t);
extern "C" int _ZN8Platform21UpdateModelPosAndRotYEv(char* t);
extern "C" int _ZN8Platform19UpdateClsnPosAndRotEv(char* t);
