...
extern void _ZN12dEnemyBase_c22SpawnMegaCharParticlesER5ActorPc(void* self, void* a, char* p);
}
        ...
        if (id != 0) {
            ...
            if (a != 0) {
                ...
                if (e1 == 0) {
                    int e2 = (t == 0x121);
                    if (e2 == 0) {
                        _ZN12dEnemyBase_c22SpawnMegaCharParticlesER5ActorPc(this, a, clsn);
                        return 1;
                    }
                }
            }
