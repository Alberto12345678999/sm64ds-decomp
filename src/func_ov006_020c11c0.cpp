...
extern "C" void _ZN14BlendModelAnim7SetAnimER8BCA_Fileii5Fix12IiEt(void *anim, void *file, int a, int b, int d, unsigned short e);
extern "C" void _ZN5Sound12PlayBank2_2DEj(unsigned id);
