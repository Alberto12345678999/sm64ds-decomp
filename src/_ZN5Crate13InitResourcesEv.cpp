...
#include "Crate.h"
extern "C" int _ZN5Model8LoadFileER13SharedFilePtr(char* f);
extern "C" void _ZN9ModelBase7SetFileEP8BMD_Fileii(char* thiz, int f, int a, int b);
extern "C" void _ZN11ShadowModel10InitCuboidEv(char* thiz);
extern "C" int _ZN12MeshCollider8LoadFileER13SharedFilePtr(char* f);
extern "C" void _ZN18MovingMeshCollider7SetFileEP8KCL_FileRK9Matrix4x35Fix12IiEsR10CLPS_Block(char* thiz, int f, char* m, int fix, short s, int blk);
extern "C" void _ZN12WithMeshClsn4InitEP5Actor5Fix12IiES3_P10Vector3_16S5_(char* thiz, char* actor, int b, int d, void* v, int f);
extern "C" void _ZN12WithMeshClsn19StartDetectingWaterEv(char* thiz);
