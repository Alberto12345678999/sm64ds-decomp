...
{
  if (DecIfAbove0_Byte((char*)&(*(s8 *)&unk_31e)) == 0) {
    short* p = (short*)(((int)((char*)this) + 0x94));
    *p = *p + 0x100;
    mAngleY = mPrevAngleY;
    (*(s32 *)&unk_320) = _ZN5Sound8PlayLongEjjjRK7Vector3s((*(s32 *)&unk_320), 3, 0x88, (void*)((char*)&mCamSpacePosX), 0);
    if ((mPrevAngleY & 0x7fff) == 0) (*(s8 *)&unk_31e) = 0x3c;
  }
