...
extern "C" int _ZN9ModelBase7SetFileEP8BMD_Fileii(char*, void*, int, int);
extern "C" void* _ZN9Animation8LoadFileER13SharedFilePtr(void*);
extern "C" int _ZN9ModelAnim7SetAnimEP8BCA_Filei5Fix12IiEj(char*, void*, int, int, unsigned int);
