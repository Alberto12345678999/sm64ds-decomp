...
extern "C" int _ZNK6Player14GetBodyModelIDEjb(Player const *, unsigned int, bool);
extern "C" int _ZNK9Animation12WillHitFrameEi(Animation const *, int);
extern "C" void func_02012790(int);
extern "C" int _ZN6Player12FinishedAnimEv(Player *);
...
extern "C" void _ZN6Player11ShowMessageER9ActorBasejPK7Vector3jj(Player *, ActorBase &, unsigned int, Vector3 const *, unsigned int, unsigned int);
