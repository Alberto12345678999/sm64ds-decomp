...
extern void _ZN8dActor_c9UpdatePosEP12CylinderClsn(Enemy *thiz, void *clsn);
extern void _ZN9Animation7AdvanceEv(void *thiz);
extern char *_ZN8dActor_c13ClosestPlayerEv(Enemy *thiz);
}
...
int CheepCheep::Behavior()
{
    ...
    _ZN8dActor_c9UpdatePosEP12CylinderClsn(((Enemy *)this), (void *)(c + 0x110));
    {
    ...
    *(int *)(c + 0x368) = 0x1000;
    ...
    _ZN12CylinderClsn5ClearEv(c + 0x110);
    {
        char *p = _ZN8dActor_c13ClosestPlayerEv(((Enemy *)this));
