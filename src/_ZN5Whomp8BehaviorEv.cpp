...
int _ZN5Enemy15IsGoingOffCliffER12WithMeshClsn5Fix12IiEsbbS3_(dActor_c* self, WithMeshClsn* w, int a, short b, int c, int d, void* e);
void _ZN5Enemy12UpdateWMClsnER12WithMeshClsnj(dActor_c* self, WithMeshClsn* w, unsigned int n);
...
int Whomp::Behavior()
{
    ...
    if (*(int*)(c + 0x98) != 0) {
        if (_ZN5Enemy15IsGoingOffCliffER12WithMeshClsn5Fix12IiEsbbS3_(((dActor_c*)this), (WithMeshClsn*)(c + 0x110), 0x3c000, (short)0x2888, 0, 0, (void*)0x32000)) {
    ...
    _ZN5Enemy12UpdateWMClsnER12WithMeshClsnj(((dActor_c*)this), (WithMeshClsn*)(c + 0x110), 0);
