...
extern "C" {
    ...
    void _ZN5Enemy22SpawnMegaCharParticlesER8dActor_cPc(void* self, void* a, void* p);
...
extern "C" void func_ov032_021113fc(void* self)
{
    ...
    if (id1 != 0) {
        ...
        if (isbf) {
            ...
            if (*(s32*)(c+0x130) & 0x10) {
                _ZN5Enemy22SpawnMegaCharParticlesER8dActor_cPc(self, f, 0);
    ...
    if (*(s32*)(c+0x170) & 0x10) {
        _ZN5Enemy22SpawnMegaCharParticlesER8dActor_cPc(self, f2, 0);
        _ZN8dActor_c8PoofDustEv(self);
