...
extern "C" int _ZN6Player11ShowMessageER9ActorBasejPK7Vector3jj(void *self, void *actor,
                                                            unsigned int msg,
                                                            const Vector3 *pos,
                                                            unsigned int a,
                                                            unsigned int b);
extern "C" int _ZN6Player12GetTalkStateEv(void *self);
extern "C" int _ZN5Sound8PlayLongEjjjRK7Vector3j(int handle, unsigned int a,
