...
extern "C" unsigned int _ZN8SaveData19IsCharacterUnlockedEj(unsigned int id);
extern "C" void _ZN3OAM6RenderEbP7OamAttriiiiP9Matrix2x2(int b, void *attr, int x, int y, int a, int cc, void *m);
extern "C" void _ZN3OAM6RenderEbP7OamAttriiii5Fix12IiES3_ii(int b, void *attr, int x, int y, int a, int cc, int fx, int t, int e, int f);
extern "C" void _ZN3OAM9RenderSubEP7OamAttrii(void *attr, int x, int y);
extern "C" void _ZN3G3i13PerspectiveW_E5Fix12IiES1_S1_S1_S1_S1_bP9Matrix4x3(int p1, int p2, int p3, int p4, int p5, int p6, int b, void *m);
extern "C" void _ZN3G3i7LookAt_EPK7Vector3S2_S2_bP9Matrix4x3(void *eye, void *at, void *up, int b, void *out);
extern "C" void _Z13CopyToViewMatPK9Matrix4x3(void *m);
