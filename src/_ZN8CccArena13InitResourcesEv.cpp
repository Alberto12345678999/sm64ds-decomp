...
#include "CccArena.h"
extern "C" int _ZN5Model8LoadFileER13SharedFilePtr(int);
extern "C" int _ZN9ModelBase7SetFileEP8BMD_Fileii(void*,int,int,int);
extern "C" int _ZN8Platform19UpdateClsnPosAndRotEv(void*);
extern "C" int _ZN12MeshCollider8LoadFileER13SharedFilePtr(int);
extern "C" int _ZN18MovingMeshCollider7SetFileEP8KCL_FileRK9Matrix4x35Fix12IiEsR10CLPS_Block(void*,int,void*,int,short,int);
extern void func_020393d4(void*,void*);
extern void func_020393c4(void*,void*);
extern "C" int _ZN16MeshColliderBase6EnableEP5Actor(void*,void*);
