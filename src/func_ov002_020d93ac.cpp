...
struct Actor;
extern "C" bool _ZN6Player8HasNoCapEv(char *self);
extern "C" void _ZN6Player18SetNewHatCharacterEjjb(char *self, u32 a, u32 b, bool c);
extern "C" char *_ZN5Actor5SpawnEjjRK7Vector3PK10Vector3_16ii(u32 a, u32 b, const Vector3 &pos, const void *v, int e, int f);
