...
extern "C" void _ZN9ModelBase7SetFileEP8BMD_Fileii(char* self, void* file, int a, int b);
extern "C" void _ZN8Platform21UpdateModelPosAndRotYEv(char* self);
extern "C" void _ZN25MovingCylinderClsnWithPos4InitEP5ActorRK7Vector35Fix12IiES6_jj(char* self, char* actor, const struct Vector3* pos, int a, unsigned int b, unsigned int c, unsigned int d);
