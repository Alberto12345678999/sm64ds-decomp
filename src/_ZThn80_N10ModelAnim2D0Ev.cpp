...
// The instruction bytes match, but the tail-call at +0x8 relocates to _ZN10ModelAnim2D1Ev (0x02016364)
// while the ROM branches to _ZN10ModelAnim2D0Ev (0x02016320). A deleting-destructor thunk that jumps
...
// all three still relocate to D1. The tell is that _ZThn80_N10ModelAnim2D1Ev
