...
extern "C" int _ZN6Player4HurtERK7Vector3j5Fix12IiEjjj(void *self, void *v, unsigned int a, int fix, unsigned int b, unsigned int d, unsigned int e);
extern "C" int _ZN6Player6BounceE5Fix12IiE(void *self, int fix);
