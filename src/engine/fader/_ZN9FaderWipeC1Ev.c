...
extern u32 _ZTV8dFader_c[];
extern u32 _ZTV15dFdBrightness_c[];
extern u32 _ZTV10dFdColor_c[];
extern u32 _ZTV9FaderWipe[];
extern void _ZN5ModelC1Ev(struct Model*);

struct FaderWipe* _ZN9FaderWipeC1Ev(struct FaderWipe* this) {
    this->vtable = (u32*)_ZTV8dFader_c;
    this->vtable = (u32*)_ZTV15dFdBrightness_c;
    this->currInterp = 0x1000;
    this->speed = 0;
    this->vtable = (u32*)_ZTV10dFdColor_c;
    this->color = 0;
