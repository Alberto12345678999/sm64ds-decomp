...
| Physical production source files | 10984 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10984 |
| Tracked `.c` files | 6195 |
| Tracked `.cpp` files | 4789 |
...
| Source-built (`complete`) source files | 10757 |
| Complete sources owning more than one function | 35 |
| Source-built records inside multi-function sources | 370 |
