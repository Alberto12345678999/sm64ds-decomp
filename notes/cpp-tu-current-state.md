...
| Strict CONVERTED source functions | 2560 / 11312 (22.63%) |
| Physical production source files | 11274 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 11274 |
| Tracked `.c` files | 6384 |
| Tracked `.cpp` files | 4890 |
...
| Source-built (`complete`) source files | 11048 |
| Complete sources owning more than one function | 6 |
| Source-built records inside multi-function sources | 49 |
...
Manifest statuses: `link-verified` 4, `promoted` 5, `text-verified` 79.
