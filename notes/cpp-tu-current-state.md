...
| Physical production source files | 10955 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10955 |
...
| Source-built (`complete`) source files | 10728 |
| Complete sources owning more than one function | 41 |
| Source-built records inside multi-function sources | 405 |
