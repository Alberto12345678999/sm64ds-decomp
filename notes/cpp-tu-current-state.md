...
| Physical production source files | 11034 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 11034 |
| Tracked `.c` files | 6270 |
| Tracked `.cpp` files | 4764 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3659 |
| Genuinely migrated C++ symbol files | 3514 |
| Not semantically migrated | 142 |
| `.cpp` files still hand-spelling their symbol | 64 |
...
| Source-built (`complete`) source files | 10807 |
| Complete sources owning more than one function | 31 |
| Source-built records inside multi-function sources | 316 |
