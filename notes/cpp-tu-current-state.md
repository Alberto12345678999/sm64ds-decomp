...
| Physical production source files | 10970 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10970 |
| Tracked `.c` files | 6193 |
| Tracked `.cpp` files | 4777 |
...
| Source-built (`complete`) source files | 10743 |
| Complete sources owning more than one function | 38 |
| Source-built records inside multi-function sources | 387 |
