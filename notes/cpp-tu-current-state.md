...
| Physical production source files | 9368 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 9368 |
| Tracked `.c` files | 5348 |
| Tracked `.cpp` files | 4020 |
...
| Source-built (`complete`) source files | 9201 |
| Complete sources owning more than one function | 123 |
| Source-built records inside multi-function sources | 2117 |
...
| Functions named by manifest entries | 2743 |
| Unique functions named by the manifest | 2732 |
