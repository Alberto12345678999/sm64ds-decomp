...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 11257 |
| Tracked `.c` files | 6375 |
| Tracked `.cpp` files | 4882 |
...
| Source-built (`complete`) source files | 11032 |
| Complete sources owning more than one function | 5 |
| Source-built records inside multi-function sources | 62 |
...
Current complete multi-function owners: `src/actors/ActorBase_SceneNode.cpp` (2 function-symbol records), `src/actors/daKpFr_c.cpp` (21 function-symbol records), `src/actors/daKrpa_c.cpp` (25 function-symbol records), `src/actors/daObjPathLift_c.cpp` (8 function-symbol records), `src/func_01ff97d8.c` (6 function-symbol records).
