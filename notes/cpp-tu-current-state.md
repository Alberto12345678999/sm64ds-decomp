...
| Strict CONVERTED source functions | 2590 / 11314 (22.89%) |
| Physical production source files | 10992 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10992 |
| Tracked `.c` files | 6195 |
| Tracked `.cpp` files | 4797 |
...
| Source-built (`complete`) source files | 10765 |
| Complete sources owning more than one function | 34 |
| Source-built records inside multi-function sources | 361 |
