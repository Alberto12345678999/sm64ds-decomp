...
| Physical production source files | 10969 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10969 |
| Tracked `.c` files | 6194 |
| Tracked `.cpp` files | 4775 |
...
| Source-built (`complete`) source files | 10742 |
| Complete sources owning more than one function | 38 |
| Source-built records inside multi-function sources | 388 |
