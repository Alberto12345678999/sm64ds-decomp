...
| Physical production source files | 11278 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 11278 |
| Tracked `.c` files | 6385 |
| Tracked `.cpp` files | 4893 |
...
| Source-built (`complete`) source files | 11052 |
| Complete sources owning more than one function | 5 |
| Source-built records inside multi-function sources | 44 |
...
Current complete multi-function owners: `src/actors/ActorBase_SceneNode.cpp` (2 function-symbol records), `src/actors/daKpFr_c.cpp` (21 function-symbol records), `src/actors/daObjAbuku_c.cpp` (7 function-symbol records), `src/actors/daObjPathLift_c.cpp` (8 function-symbol records), `src/func_01ff97d8.c` (6 function-symbol records).
