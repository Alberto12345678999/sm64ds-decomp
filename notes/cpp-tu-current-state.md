...
| Strict CONVERTED source functions | 2543 / 11314 (22.48%) |
| Physical production source files | 11223 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 11223 |
| Tracked `.c` files | 6364 |
| Tracked `.cpp` files | 4859 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3560 |
| Genuinely migrated C++ symbol files | 3486 |
...
| Source-built (`complete`) source files | 10996 |
| Complete sources owning more than one function | 16 |
...
| Entries actually production-enrolled at `promoted_source` | 15 |
| Existing promotion paths that disagree with delinks | 0 |

Manifest statuses: `link-verified` 3, `promoted` 15, `text-verified` 72.
