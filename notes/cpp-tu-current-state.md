...
| Physical production source files | 11038 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 11038 |
| Tracked `.c` files | 6271 |
| Tracked `.cpp` files | 4767 |
| `.cpp` files missing first-line `//cpp` | 0 |
| Mangled-symbol source files | 3587 |
...
| Source-built (`complete`) source files | 10811 |
| Complete sources owning more than one function | 30 |
| Source-built records inside multi-function sources | 311 |
...
Manifest statuses: `link-verified` 3, `promoted` 29, `text-verified` 65.
