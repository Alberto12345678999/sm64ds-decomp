...
| Physical production source files | 10972 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10972 |
...
| Source-built (`complete`) source files | 10745 |
| Complete sources owning more than one function | 38 |
| Source-built records inside multi-function sources | 385 |
