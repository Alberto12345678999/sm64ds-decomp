...
| Physical production source files | 10959 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10959 |
...
| Source-built (`complete`) source files | 10732 |
| Complete sources owning more than one function | 40 |
| Source-built records inside multi-function sources | 400 |
