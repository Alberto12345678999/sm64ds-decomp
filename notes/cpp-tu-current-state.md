...
| Physical production source files | 10961 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10961 |
...
| Source-built (`complete`) source files | 10734 |
| Complete sources owning more than one function | 40 |
| Source-built records inside multi-function sources | 398 |
