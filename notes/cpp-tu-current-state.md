...
| Physical production source files | 10973 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10973 |
| Tracked `.c` files | 6194 |
| Tracked `.cpp` files | 4779 |
...
| Source-built (`complete`) source files | 10746 |
| Complete sources owning more than one function | 37 |
| Source-built records inside multi-function sources | 383 |
