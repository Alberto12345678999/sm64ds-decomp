...
| Physical production source files | 10951 |
...
| Measure | Live value |
| --- | ---: |
| Tracked production source files | 10951 |
| Tracked `.c` files | 6190 |
| Tracked `.cpp` files | 4761 |
...
| Source-built (`complete`) source files | 10724 |
| Complete sources owning more than one function | 42 |
| Source-built records inside multi-function sources | 410 |
