...
**Rung 2 -- unmigrated function** (exemplar shard since promoted -- the shape below
is what `src/_ZN19daObjBlockItemTag_cD0Ev.cpp` looked like pre-promotion; the
code now lives in `src/actors/daObjBlockItemTag_c.cpp`):
