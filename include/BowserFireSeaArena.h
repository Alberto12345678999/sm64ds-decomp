 ...
 * and tears down two more at Platform's offsets, then chains to dActor_c. That middle
...
/* The same object for a C translation unit, which has no base class to inherit
   Platform's and dActor_c's fields from and so spells the whole layout flat. */
