#ifndef FLOAT_ON_WATER_PLATFORM_WDW_RECTANGLE_H
#define FLOAT_ON_WATER_PLATFORM_WDW_RECTANGLE_H

#include "types.h"
#include "daObjFloatBoard_c.h"

/* class FloatOnWaterPlatformWdwRectangle -- Wet-Dry World's rectangular floating platform (ov029).
 *
 * Base is daObjFloatBoard_c, NOT Platform. Its destructor at 0x02111ea4 stores three
...
struct FloatOnWaterPlatformWdwRectangle : daObjFloatBoard_c {
    virtual ~FloatOnWaterPlatformWdwRectangle();
};
