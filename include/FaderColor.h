 ...
 * FaderColor's own.
 *
 * DERIVATION. _ZN9FaderWipeC1Ev (0x02017480) writes _ZTV8dFader_c, then
 * _ZTV15dFdBrightness_c, then _ZTV10dFdColor_c, then _ZTV9FaderWipe, in that
 ...
 *
 * VTABLE. _ZTV10dFdColor_c is ten slots and overrides exactly one,
