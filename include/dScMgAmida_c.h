...
struct dScMgAmida_c : dScMgBase_c {
    ...
    /* Overrides dScMgBase_c's slot 18, so the base fixes its index.  Unk36
       below is NOT an override: dScMgBase_c declares through 34 today, so mwcc
       lands Unk36 on 35 and _ZTV12dScMgAmida_c scores DIFFERS on that one
       ...
       inserted above it would take 35 and push it further out. */
