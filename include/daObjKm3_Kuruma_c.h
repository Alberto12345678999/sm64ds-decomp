...
/* Bowser in the Sky's rickshaw platform -- the cart on the axle. Its
 * reconstructed factory is daObjKm3_Kuruma_c_classInit (historical alias
 * RickshawPlatformBs_Spawn), paired by vtable address. This differs from its
 * sibling daObjKm3_Kurumajiku_c_classInit (historical alias
 ...
 * daObjKm3_Kuruma_c_classInit passes 800 = 0x320 = sizeof(dBgActor_c); there
 * is no room for one. This class overrides slots 0 and 3, which the base leaves
 * null.
 */
