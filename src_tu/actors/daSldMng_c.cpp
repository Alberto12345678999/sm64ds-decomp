 ...
 *   [1] 0x02112640  src/_ZN10daSldMng_cD0Ev.c
...
#define DASLDMNG_C_H  /* suppress the flat C header; the TU-local class below is the C++ view, same evidenced offsets */
...
int *daSldMng_c_Spawn(void)
{
    ...
    if (p) { _ZN8dActor_cC2Ev(p); p[0] = (int)&_ZTV10daSldMng_c[2]; /* +8: this TU defines the vtable */ }
    return p;
}
}
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 1 -- _ZN10daSldMng_cD0Ev, 0x02112640, size 0x38 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN10daSldMng_cD0Ev
/* recovered: named members + shared header, declarations from a shared header */
/* recovered: named members + shared header */
extern "C" {  /* .c-derived member: C linkage for the whole block */
/* (no separate definition: the single ~daSldMng_c() below emits the D0 and D1
 * variants together -- a hand-mangled D0 next to a real destructor is the
 * known mwccarm ICE, ELFgen.c:483.) */
}

/* -------------------------------------------------------------------------- */
/* ROM ordinal 0 -- _ZN10daSldMng_cD1Ev, 0x0211261c, size 0x24 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN10daSldMng_cD1Ev
daSldMng_c::~daSldMng_c()
{
}
