 ...
 * ov045/daObjKm2_Fall_Block_c  (5 function(s))
 *
 ...
 *   [0] 0x02111d48  src/_ZN21daObjKm2_Fall_Block_cD1Ev.c
 *   [1] 0x02111d98  src/_ZN21daObjKm2_Fall_Block_cD0Ev.c
 *   [2] 0x02111dfc  src/_ZN21daObjKm2_Fall_Block_c16CleanupResourcesEv.c
 *   [3] 0x02111e10  src/_ZN21daObjKm2_Fall_Block_c13InitResourcesEv.c
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 3 -- _ZN21daObjKm2_Fall_Block_c13InitResourcesEv, 0x02111e10, size 0x14 */
/* -------------------------------------------------------------------------- */
int _ZN21daObjKm2_Fall_Block_c13InitResourcesEv(void *self)
{
    return func_ov098_0213a794(self, data_ov045_021130ac);
}

/* -------------------------------------------------------------------------- */
/* ROM ordinal 2 -- _ZN21daObjKm2_Fall_Block_c16CleanupResourcesEv, 0x02111dfc, size 0x14 */
/* -------------------------------------------------------------------------- */
int _ZN21daObjKm2_Fall_Block_c16CleanupResourcesEv(void *self)
{
    return func_ov098_0213a2cc(self, data_ov045_021130ac);
}

/* -------------------------------------------------------------------------- */
/* ROM ordinal 1 -- _ZN21daObjKm2_Fall_Block_cD0Ev, 0x02111d98, size 0x64 */
/* -------------------------------------------------------------------------- */
...
int *_ZN21daObjKm2_Fall_Block_cD0Ev(int *t)
{
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 0 -- _ZN21daObjKm2_Fall_Block_cD1Ev, 0x02111d48, size 0x50 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN21daObjKm2_Fall_Block_cD1Ev
/* recovered: named members + shared header, vtable identified, declarations from a shared header */
/* recovered: named members + shared header, vtable identified */
/* vtable identified: VT0 = _ZTV21daObjKm2_Fall_Block_c; VT1 = _ZTV10dBgActor_c */
int *_ZN21daObjKm2_Fall_Block_cD1Ev(int *t)
{
    t[0] = (int)_ZTV21daObjKm2_Fall_Block_c;
    t[0] = (int)_ZTV10dBgActor_c;
    t[0] = (int)_ZTV10dBgActor_c;
