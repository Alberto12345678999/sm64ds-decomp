 ...
 *   [1] 0x021120a8  src/_ZN10daMcFlag_cD0Ev.c
 *   [2] 0x021120ec  src/_ZN10daMcFlag_c16CleanupResourcesEv.c
...
#define DAMCFLAG_C_H  /* suppress include/daMcFlag_c.h: its daMcFlag_c is the flat C view without the destructor; the TU-local class below is the C++ view, same evidenced offsets */
#include "ModelAnim.h"
 ...
 * exactly the offsets include/daMcFlag_c.h records (mPosX 0x5c, mAngleY 0x8e). The
 * inline operator delete is dActor_c's own (include/dActor_c.h), which is what
 * lets the single ~daMcFlag_c() below reproduce the ROM's deleting destructor D0. */
struct dActor_c {
    char  pad0[0x58];
...
/* resolved: VT0 = _ZTV10daMcFlag_c */
extern "C" int *daMcFlag_c_Spawn(void)
{
    int *p = (int *)_ZN7fBase_cnwEj(312);
    if (p) {
        _ZN8dActor_cC2Ev(p);
        p[0] = (int)&_ZTV10daMcFlag_c[2]; /* +8: this TU defines the vtable */
...
/* -------------------------------------------------------------------------- */
extern "C" int _ZN10daMcFlag_c16CleanupResourcesEv(void)
{
...
/* -------------------------------------------------------------------------- */
/* ROM ordinal 1 -- _ZN10daMcFlag_cD0Ev, 0x021120a8, size 0x44 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN10daMcFlag_cD0Ev
/* (no separate definition: the single ~daMcFlag_c() below emits the D0 and D1
 ...
 * same vtable address _ZTV10daMcFlag_c names.) */

/* -------------------------------------------------------------------------- */
/* ROM ordinal 0 -- _ZN10daMcFlag_cD1Ev, 0x02112078, size 0x30 */
/* -------------------------------------------------------------------------- */
// @symbol _ZN10daMcFlag_cD1Ev
daMcFlag_c::~daMcFlag_c()
{
}
